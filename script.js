...
for (let i = 0; i < timeBlocks.length; i++) {
  ...
  let hour = parseInt(timeBlocks[i].id.substring(5));
  console.log(hour);
  ...
  let textArea = timeBlocks[i].querySelector('.description');
  textArea.value = localStorage.getItem(hour)
  timeBlocks[i].querySelector('.saveBtn').addEventListener("click",function () {
